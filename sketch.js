...
function preload() {
    ...
    bgSplash = loadImage("assets/bg-splash.png");
    ...
    JOYSTIX = loadFont('assets/joystix.ttf');
    BPDOTS = loadFont('assets/bpdots.ttf');
...
function draw() {
    ...
    function splash() {
        ...
        noSmooth();
        background(125, 165, 241);
        image(bgSplash, width / 2, height / 2, width, height);
        noStroke();    fill(255);
        textFont(JOYSTIX);
        textSize(80);
        text("Digital Cleaner", width / 2, 120);
        fill(130, 205, 48);
        fill(255);
        textFont(BPDOTS);
        textSize(20);
        text("BY MMI STUDIOS", width / 2, 160);
        fill(130, 205, 48);
        rect(width / 2, height / 2 + 40, 300, 55, 0);
        fill(255);
        textFont(BPDOTS);
        textSize(30);
        text("Start clean UP", width / 2, height / 2 + 50);
        ...
        fill("white");
        rect(width / 2 - 77.5, height / 2 + 105, 145, 55, 0);
        fill(130, 205, 48);
        textFont(BPDOTS);
        textSize(30);
